...
<head>
    ...
    <style>
        ...
        .card {{ background: white; border-radius: 16px; padding: 20px; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(0,0,0,0.05); border-top: 6px solid #89cff0; }}
...
for s in schools:
    ...
    <div class="card">
        ...
        <div class="btn-group">
            <a href="{s['openDayUrl']}" class="btn btn-open" target="_blank">開放日專頁</a>
            <a href="{s['examUrl']}" class="btn btn-reg" target="_blank">報考詳情</a>
        </div>
    </div>
    """

html += """
        <div class="footer">考試順利，品學兼優</div>
    </div>
</body>
</html>
"""
